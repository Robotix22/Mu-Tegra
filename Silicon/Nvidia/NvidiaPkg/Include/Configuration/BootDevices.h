...
typedef struct {
  VENDOR_DEVICE_PATH       VendorDevicePath;
  EFI_DEVICE_PATH_PROTOCOL EndDevicePath;
} EFI_TEGRA_KEYBOARD_DEVICE_PATH;
...
#define EFI_TEGRA_KEYBOARD_DEVICE_GUID                                             \
  {                                                                            \
...
EFI_TEGRA_KEYBOARD_DEVICE_PATH TegraKeyboardDevicePath =
{
  {
    {
      HARDWARE_DEVICE_PATH,
    ...
    EFI_TEGRA_KEYBOARD_DEVICE_GUID
  },
  {
    END_DEVICE_PATH_TYPE,
    END_ENTIRE_DEVICE_PATH_SUBTYPE,
