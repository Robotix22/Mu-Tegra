/** @file
  ...
  provided by TegraKeyboardController.c
...
/**
    ...
    @param ConsoleInDev             Keyboard private structure
  ...
  OUT EFI_KEY_DATA            *KeyData)
{
  ...
  if (ConsoleInDev->KeyboardErr) {
    DEBUG ((EFI_D_ERROR, "An Keyboard Error occured!\n"));
  ...
  IN BOOLEAN                         ExtendedVerification)
{
  ...
  if (EFI_ERROR(Status)) {
    ...
    //
    gBS->RestoreTPL(OldTpl);
    DEBUG ((EFI_D_ERROR, "Failed to Init Keyboard!\n"));
    return EFI_DEVICE_ERROR;
  }
