/** @file
  Tegra Keyboard driver header file.
...
#ifndef _TEGRA_KEYBOARD_H_
#define _TEGRA_KEYBOARD_H_
...
extern EFI_COMPONENT_NAME_PROTOCOL  gKeyboardComponentName;
extern EFI_COMPONENT_NAME2_PROTOCOL gKeyboardComponentName2;
...
#define KEYBOARD_CONSOLE_IN_DEV_FROM_KEYBOARD_RETURN_API(a)                        \
  CR(a, KEYBOARD_CONSOLE_IN_DEV, KeyboardReturnApi, KEYBOARD_CONSOLE_IN_DEV_SIGNATURE)
...
#define TEXT_INPUT_EX_KEYBOARD_CONSOLE_IN_DEV_FROM_THIS(a)                       \
  CR(a, KEYBOARD_CONSOLE_IN_DEV, ConInEx, KEYBOARD_CONSOLE_IN_DEV_SIGNATURE)
...
//
/**
  The user Entry Point for module TegraKeyboardDxe. The user code starts with this function.
